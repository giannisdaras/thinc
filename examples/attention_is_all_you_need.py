...
def main(heads=6, dropout=0.1, stack=6, batch_size=2):
    ...
    _1, _2, _3 = yh.shape
    backprop(Model.ops.xp.random.rand(_1, _2, _3, dtype=Model.ops.xp.float32))
    ...
    #         x0, x1, x2 = yh.shape
    #         backprop(Model.ops.xp.random.rand(x0, x1, x2).astype(Model.ops.xp.float32))
